...
public class TicTacToeActivityGoogle extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://cognicare-b655f-default-rtdb.firebaseio.com/");
        ...
        wonEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.hasChild("player_id")) {
                    ...
                    final WinDialogGoogle1 winDialogGoogle11;

                    if (getWinPlayerId.equals(playerUniqueId)) {

                        // show win dialog
                        winDialogGoogle11 = new WinDialogGoogle1(TicTacToeActivityGoogle.this, "You won the game");
                    } else {

                        // show win dialog
                        winDialogGoogle11 = new WinDialogGoogle1(TicTacToeActivityGoogle.this, "Opponent won the game");
                    }

                    winDialogGoogle11.setCancelable(false);
                    winDialogGoogle11.show();
    ...
    private void selectBox(ImageView imageView, int selectedBoxPosition, String selectedByPlayer) {
        ...
        if (doneBoxes.size() == 9) {
            ...
            final WinDialog winDialog = new WinDialog(TicTacToeActivityGoogle.this, "It is a Draw!");

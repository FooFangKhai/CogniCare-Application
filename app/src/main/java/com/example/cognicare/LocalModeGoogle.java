...
public class LocalModeGoogle extends AppCompatActivity {
    ...
    private void selectBox(ImageView imageView, int selectedBoxPosition, int playerTurn) {
        ...
        if (checkPlayerWin(playerTurn)) {
            ...
            if (playerTurn == 1) {
                ...
                // show win dialog
                winDialogGoogle = new WinDialogGoogle(LocalModeGoogle.this, "You won the game");
            } else {

                // show win dialog
                winDialogGoogle = new WinDialogGoogle(LocalModeGoogle.this, "Opponent won the game");
            }
        ...
        if (doneBoxes.size() == 9) {
            ...
            final WinDialogGoogle winDialogGoogle = new WinDialogGoogle(LocalModeGoogle.this, "It is a Draw!");
            winDialogGoogle.setCancelable(false);
            winDialogGoogle.show();
        }
    }

...
public class TicTacToeActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.hasChild("player_id")) {
                    ...
                    if (getWinPlayerId.equals(playerUniqueId)) {
                        ...
                        // show win dialog
                        winDialog1 = new WinDialog1(TicTacToeActivity.this, "You won the game");
                    } else {

                        // show win dialog
                        winDialog1 = new WinDialog1(TicTacToeActivity.this, "Opponent won the game");
                    }
    ...
    private void selectBox(ImageView imageView, int selectedBoxPosition, String selectedByPlayer) {
        ...
        if (doneBoxes.size() == 9) {
            ...
            final WinDialog winDialog = new WinDialog(TicTacToeActivity.this, "It is a Draw!");

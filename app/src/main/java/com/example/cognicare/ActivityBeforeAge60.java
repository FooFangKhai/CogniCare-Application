...
public class ActivityBeforeAge60 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_before_age60);
    ...
    public void Imagebuttonclicked(View view) {
        for (int i = 0; i < newArray.length; i++) {
            if (view.getId() == newArray[i]) {
                ...
                Intent intent = new Intent(ActivityBeforeAge60.this, InstructionsActivity.class);

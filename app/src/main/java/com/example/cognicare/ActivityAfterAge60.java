...
public class ActivityAfterAge60 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_after_age60);
    ...
    public void Imagebuttonclicked(View view) {
        for (int i = 0; i < newArray.length; i++) {
            if (view.getId() == newArray[i]) {
                ...
                Intent intent = new Intent(ActivityAfterAge60.this, InstructionActivity2.class);
